...
const createElement = (type, props = {}, ...children) => {
  ...
  if (type.prototype && type.prototype.isRectaClassComponent) {
...
class Component {
  ...
  setState(partialState) {
    ...
    // Вызываем метод __updater, которая назначается в RectaDom
    Recta.__updater(this);
  }
...
Component.prototype.isRectaClassComponent = true;

// Экспортируем как Recta.createElement и Recta.Component
const Recta = {
  createElement,
  Component
};
